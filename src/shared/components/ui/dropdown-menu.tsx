...
import { Check } from "@/shared/lib/icons/Check";
import { ChevronDown } from "@/shared/lib/icons/ChevronDown";
import { ChevronRight } from "@/shared/lib/icons/ChevronRight";
import { ChevronUp } from "@/shared/lib/icons/ChevronUp";
...
function DropdownMenuLabel({
  ...
  return (
    <TextClassContext.Provider value="select-none text-sm native:text-lg font-medium text-popover-foreground">
      <DropdownMenuPrimitive.Label
        className={cn(
          "px-2 py-1.5 native:py-2",
